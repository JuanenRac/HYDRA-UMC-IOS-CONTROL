...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — pianificato: una UI touch nativa per il touchscreen DSI da 7" proprio di HYDRA-UMC (1280×800) sulla Compute Module 5, che controlla questo stesso server direttamente dalla scheda. Non ancora iniziato.
