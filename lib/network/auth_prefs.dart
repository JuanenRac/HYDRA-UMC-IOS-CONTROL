...
class AuthPrefs {
  ...
  // `refreshToken` is optional and named so an older caller (or a
  ...
  /// the opaque refresh token, or null - no refresh token on file (a
  ...
  Future<void> clearToken() async {
    ...
    try {
      ...
      // the refresh token dies with the session it belonged to.
