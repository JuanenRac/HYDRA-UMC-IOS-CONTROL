...
Les deux produisent `build/windows/x64/runner/Release/hydra_umc_control.exe`.
...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — prévu : une UI tactile native pour l'écran tactile DSI 5"/7" propre de HYDRA-UMC (1280×720, même résolution dans les deux tailles) sur la Compute Module 5, contrôlant ce même serveur directement depuis la carte. Pas encore commencé.
